...
class LevelScreen(Screen, SpriteAdder):
    ...
    legendlayout: FloatLayout = ObjectProperty(None)
    ...
    def __init__(self, **kwargs):
        ...
        self.static_sprites = []
        self.legends = {"score": None, "lives": None, "kunai_count": None}
        ...
        self.bg_image = "assets/images/Tiles/BG.png"
    ...
    def load(self, level):
        ...
        # self.mainlayout.add_widget(Label(text="Hsyyfgarfy"))

        # from utils.controls import AndroidControls
        # self.controls = AndroidControls()
        # self.controls.turn_on(self.player, self)
    ...
    def end(self):
        self.player.sounds["BackgroundMusic"].stop()
        if platform.lower() == "windows":
            for i in self.player.sounds:
                self.player.sounds[i].unload()
        ...
        self.mainlayout.add_widget(GameOver())
        self.paused = True
    ...
    def on_key_down(self, keyboard, keycode, text, modifiers):
        ...
        if self.player is not None:
            self.player.on_key_down(keyboard, keycode, text, modifiers)
    ...
    def on_key_up(self, keyboard, keycode):
        ...
        if self.player is not None:
            self.player.on_key_up(keyboard, keycode)
