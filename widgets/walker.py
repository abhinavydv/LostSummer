...
class Walker(DynamicSprite):
    ...
    def on_collide(self, other, col):
        if other.is_abstract or other.tag=="collectible":
            return
        if col[2] == "right":
    ...
    def mario_collided(self, player, col):
        if player.is_invincible:
            self.parent.parent.legends["score"].score += self.score_gain
            self.get_blown()
...
class Goomba(Walker):
    ...
    def mario_collided(self, player, col):
        if not self.dead:
            super().mario_collided(player, col)
...
class Koopa(Walker):
            ...
            if self.animate_time >= 15 and self.relative_velocity[0] == 0:
                ...
                if self.direction == "Right":
                    ...
                    self.relative_velocity[0] = - \
                        self.max_relative_velocity[0] / 2
    ...
    def on_collide(self, other, col):
        if not other.is_static and self.in_shell and self.relative_velocity[0] != 0:
            if other.tag == "player" and other.is_invincible:
                self.get_blown()
            else:
                other.get_blown()
            return
...
class Slime(Walker):
    ...
    def __init__(self, **kwargs):
        ...
        self.image = "assets/images/SlimeGreen/SlimeBasic_00000.png"
        self.i = 0
        self.animate_time = 0
        self.dead = False
    ...
    def animate(self, levelscreen, dt):
        if self.dead:
            ...
            return
        self.animate_time += dt
        # print("Animation", self.animate_time)
        ...
        if self.i > 29:
            self.i = 0
        self.image = f"assets/images/SlimeGreen/SlimeBasic_000{'0'*(2-len(str(self.i)))+str(self.i)}.png"
        # print(f"assets/images/SlimeGreen/SlimeBasic_000{'0'*(2-len(str(self.i)))+str(self.i)}.png")
...
class SlimeOrange(Walker):
    ...
    def __init__(self, **kwargs):
        ...
        self.image = "assets/images/SlimeOrange/SlimeOrange_00000.png"
        self.i = 0
        self.animate_time = 0
        self.dead = False
    ...
    def animate(self, levelscreen, dt):
        ...
        if self.i > 29:
            self.i = 0
        self.image = f"assets/images/SlimeOrange/SlimeOrange_000{'0'*(2-len(str(self.i)))+str(self.i)}.png"
        # print(f"assets/images/SlimeGreen/SlimeBasic_000{'0'*(2-len(str(self.i)))+str(self.i)}.png")
